#Tensorflow Seq2Seq(LSTM)
#https://github.com/sachinruk/deepschool.io/blob/master/Lesson%2019%20-%20Seq2Seq%20-%20Date%20translator%20-%20Solutions.ipynb
#https://www.youtube.com/watch?v=_Sm0q_FckM8

#Otherthan this look into the following tutorials
...
batch_size = 128
#connect outputs to 
logits = tf.contrib.layers.fully_connected(dec_outputs, num_outputs=len(y_pad), activation_fn=None) 
