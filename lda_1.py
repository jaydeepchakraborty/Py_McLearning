...
print("----------------------------")
print(" returns most likely topics for a particular word in vocab.")
print(ldamodel.get_term_topics('health'))
print("----------------------------")

print("----------------------------")
print("Return a list of (word_id, probability) 2-tuples for the most probable words in topic topicid.")
print(ldamodel.get_topic_terms(1, topn=10))
print("----------------------------")
