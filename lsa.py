...
# generate LSA model
lsamodel = gensim.models.lsimodel.LsiModel(corpus, num_topics=3, id2word = dictionary)

print("----------------------------")
print("topics are")
print(lsamodel.show_topics(num_topics=3, num_words=3))
print("----------------------------")
...
print(texts[0])
print(corpus[0])
prof_topics_dist = lsamodel[corpus[0]]
print(prof_topics_dist)#gives topic distribution of the document[0]
print("----------------------------")
